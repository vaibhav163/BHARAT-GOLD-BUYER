...
import CashforSilver from '../../assets/cashforsilver.png';
    ...
    <div className="header-section">
      <div className="hero-container">
        <div className="hero-background">
          <img src={CashforSilver} alt="we buy silver" className="hero-bg-image" />
        ...
        <div className="hero-content">
          <h1 className="hero-title">Cash Against silver</h1>
        </div>
      </div>
          ...
          <div className="decorative-card-section">
            <div>
              <div className="card-border">
                <img src={CashforSilver} alt="we buy gold" className="hero-bg-image" />
            </div>
            </div>
            <div className='main-container-text'>
              <h1 style={{ color: '#DAA520', fontSize: '2rem',
                paddingBottom: '2rem'
               }}>Cash Against Silver - Sell cash for silver in Ghaziabad, Noida & Delhi ncr</h1>
              <p style={{ paddingBottom: '2rem' , fontSize: '18px', lineHeight: '1.6', margin: 0 }}>Are you looking to get <b>instant cash against your silver</b> in Delhi, Noida, Gurgaon, Ghaziabad, Faridabad, or Greater Noida?
<b>Bharat Gold Buyer</b> offers trusted, reliable, and transparent cash-for-silver services with multiple branches across the Delhi NCR area. Get the best value for your silver assets without any hassle!</p>
            </div>
            <h1 style={{ color: '#DAA520', fontSize: '2rem',
                paddingBottom: '2rem'
               }} >Why Choose Sell Cash for silver in Noida, Gurgaon & Delhi NCR?</h1>
            <p style={{ paddingBottom: '2rem' , fontSize: '18px', lineHeight: '1.6', margin: 0 }} ><b>Bharat Gold Buyer</b> is your trusted partner for selling silver in Noida, Gurgaon, and Delhi NCR. Our commitment to transparency, fair pricing, and customer satisfaction sets us apart. Experience a hassle-free process and get the best value for your silver assets with us.</p>
            <ul style={{ paddingBottom: '2rem' , fontSize: '18px', lineHeight: '1.6', margin: 0 }}>
              ...
              <li><b>Instant Cash:</b> Get immediate payment for your silver, ensuring a quick and efficient selling experience.</li>
      ...
      >
        <li>Silver coins (government and private mint)</li>
        <li>Silver jewellery including chains, rings, bangles, and earrings</li>
        <li>Silver utensils like plates, bowls, spoons, and trays</li>
        <li>Silver bars and bullion</li>
        <li>Broken or damaged silver items</li>
      </ul>
      <p
        style={{
          paddingBottom: "2rem",
      ...
      >
        How Does Our Cash Against Silver Service Work?
      </h1>
      <ol
        style={{
          paddingBottom: "2rem",
      ...
      >
        <li>
          <b>Visit Our Branch:</b> Bring your silver items to any of our
          conveniently located branches in Delhi NCR.
        </li>
        <li>
          <b>Expert Appraisal:</b> Our professionals will assess the purity and
          weight of your silver to provide an accurate valuation.
        </li>
        <li>
        ...
        <li>
          ...
          selling your silver simple and worry-free.
        </li>
      </ol>
      ...
      >
        Benefits of Selling Silver with Bharat Gold Buyer
      </h1>
      <ul
        style={{
          paddingBottom: "2rem",
      ...
      >
        <li>
          <b>Quick Access to Funds:</b> Get instant cash for your silver assets
          without delays.
        </li>
        <li>
          <b>Fair Market Value:</b> We offer competitive prices based on
          real-time silver market rates.
        </li>
        <li>
