...
import cashforcoins from '../../assets/cashforcoins.png';
import { Link } from 'react-router-dom';

export default function Cashforcoins() {
    ...
    <div className="header-section">
      <div className="hero-container">
        <div className="hero-background">
          <img src={cashforcoins} alt="we buy gold and silver coins" className="hero-bg-image" />
          ...
          <div className="decorative-card-section">
            <div>
              <div className="card-border">
                <img src={cashforcoins} alt="we buy gold" className="hero-bg-image" />
            </div>
            </div>
            <div className='main-container-text'>
              <h1 style={{ color: '#DAA520', fontSize: '2rem',
                paddingBottom: '2rem'
               }}>Cash Against gold and silver coins - Sell cash for gold and silver coins in Ghaziabad, Noida & Delhi ncr</h1>
              <p style={{ paddingBottom: '2rem' , fontSize: '18px', lineHeight: '1.6', margin: 0 }}>Are you looking to get <b>instant cash against your gold and silver coins</b> in Delhi, Noida, Gurgaon, Ghaziabad, Faridabad, or Greater Noida?
<b>Bharat Gold Buyer</b> offers trusted, reliable, and transparent cash-for-gold and silver coins services with multiple branches across the Delhi NCR area. Get the best value for your gold and silver coins assets without any hassle!</p>
            </div>
            <h1 style={{ color: '#DAA520', fontSize: '2rem',
                paddingBottom: '2rem'
               }} >Why Choose Sell Cash for gold and silver coins in Noida, Gurgaon & Delhi NCR?</h1>
            <p style={{ paddingBottom: '2rem' , fontSize: '18px', lineHeight: '1.6', margin: 0 }} ><b>Bharat Gold Buyer</b> is your trusted partner for selling gold and silver coins in Noida, Gurgaon, and Delhi NCR. Our commitment to transparency, fair pricing, and customer satisfaction sets us apart. Experience a hassle-free process and get the best value for your gold and silver coins assets with us.</p>
            <ul style={{ paddingBottom: '2rem' , fontSize: '18px', lineHeight: '1.6', margin: 0 }}>
              ...
              <li><b>Instant Cash:</b> Get immediate payment for your gold and silver coins, ensuring a quick and efficient selling experience.</li>
            ...
            {/* <h3 style={{ color: '#DAA520', fontSize: '1.5rem', paddingBottom: '1rem' }}>What gold and silver coins Items Do We Buy?</h3>
            ...
            {/* What gold and silver coins Items We Buy */}
      <h1
        style={{
          color: "#DAA520",
          fontSize: "2rem",
      ...
      >
        What gold and silver coins Items Do We Buy?
      </h1>
      <ul
        style={{
          paddingBottom: "2rem",
      ...
      >
        <li>gold and silver coins coins (government and private mint)</li>
        <li>gold and silver coins jewellery including chains, rings, bangles, and earrings</li>
        <li>gold and silver coins utensils like plates, bowls, spoons, and trays</li>
        <li>gold and silver coins bars and bullion</li>
        <li>Broken or damaged gold and silver coins items</li>
      </ul>
      <p
        style={{
          paddingBottom: "2rem",
      ...
      >
        ✅ All items are tested for purity and evaluated fairly according to live
        gold and silver coins market rates.
      </p>
      ...
      >
        How Does Our Cash Against gold and silver coins Service Work?
      </h1>
      <ol
        style={{
          paddingBottom: "2rem",
      ...
      >
        <li>
          <b>Visit Our Branch:</b> Bring your gold and silver coins items to any of our
          conveniently located branches in Delhi NCR.
        </li>
        <li>
          <b>Expert Appraisal:</b> Our professionals will assess the purity and
          weight of your gold and silver coins to provide an accurate valuation.
        </li>
        <li>
        ...
        <li>
          ...
          selling your gold and silver coins simple and worry-free.
        </li>
      </ol>
      ...
      >
        Benefits of Selling gold and silver coins with Bharat Gold Buyer
      </h1>
      <ul
        style={{
          paddingBottom: "2rem",
      ...
      >
        <li>
          <b>Quick Access to Funds:</b> Get instant cash for your gold and silver coins assets
          without delays.
        </li>
        <li>
          <b>Fair Market Value:</b> We offer competitive prices based on
          real-time gold and silver coins market rates.
        </li>
        <li>
          <b>Secure Transactions:</b> Your safety is our priority—transactions
        ...
        <li>
          ...
          <div className="services-info">
            ...
            <p className="services-description">
              ...
              Whether you want to sell gold, gold and silver coins, or diamond valuables, we make the process 
